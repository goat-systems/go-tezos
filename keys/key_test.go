...
func Test_CheckSignatureTz1(t *testing.T) {
	...
	pk, _ := FromBase58Pk("edpkvGfYw3LyB1UcCahKQk4rF2tvbMUk8GFiTuMjL75uGXrpvKXhjn", Ed25519)
...
func Test_CheckSignatureTz2(t *testing.T) {
	...
	pk, _ := FromBase58Pk("sppk7b4TURq2T9rhPLFaSz6mkBCzKzfiBjctQSMorvLD5GSgCduvKuf", Secp256k1)
...
func Test_CheckSignatureTz3(t *testing.T) {
	...
	pk, _ := FromBase58Pk("p2pk65zwHGP9MdvANKkp267F4VzoKqL8DMNpPfTHUNKbm8S9DUqqdpw", Secp256k1)
